...
/******/ 	__webpack_require__.p = "/crappy-preact-fargate-calculator/";
/******/
...
module.exports = {"profile":"profile__1Z9cd"};
...
var ram = 0.5;
var vcpu = 0.25;
var cost = ram * 0.004445 + vcpu * 0.04048;
...
var _ref13 = Object(preact_min["h"])(
	'div',
	null,
	'note: these prices are from Jan 7 2019 for us-east-1'
);
...
var app_App = function (_Component) {
	...
	function App() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
			...
			_this.setState({
				cost: _this.state.ram * 0.004445 + _this.state.vcpu * 0.04048
			});
	...
	App.prototype.render = function render(_ref, _ref2) {
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					'select',
					{ value: this.state.vcpu, onChange: this.handleVcpuChange },
					_ref5,
					_ref6,
					_ref7,
					_ref8,
